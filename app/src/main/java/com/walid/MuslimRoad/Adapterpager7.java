...
public class Adapterpager7 extends PagerAdapter {
    int a=0;
    int c=18;
    int current_index = 0;
    Context context;
    ...
    public Adapterpager7(Context context, List<itempager1> listpager7) {
        this.context = context;
        this.listpager7 = listpager7;
    }

    @Override
    public int getCount() {
        return   listpager7.size();
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager7.get(position).getTexts1());
        tests2.setText(listpager7.get(position).getTexts2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager7.get(position).getTexts1()+"\n"+listpager7.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
