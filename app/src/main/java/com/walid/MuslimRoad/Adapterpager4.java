...
public class Adapterpager4 extends PagerAdapter {
    ...
    public Adapterpager4(Context context, List<itempager1> listpager4) {
        this.context = context;
        this.listpager4 = listpager4;
    }

    @Override
    public int getCount() {
        return   listpager4.size();
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager4.get(position).getTexts1());
        tests2.setText(listpager4.get(position).getTexts2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager4.get(position).getTexts1()+"\n"+listpager4.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
