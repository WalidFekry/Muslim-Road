...
public class Adapterpager3 extends PagerAdapter {
    ...
    public Adapterpager3(Context context, List<itempager1> listpager3) {
        this.context = context;
        this.listpager3 = listpager3;
    }
    @Override
    public int getCount() {
        return   listpager3.size();
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        final View view=inflater.inflate(R.layout.item_pager2,container,false);
        final TextView tests1=(TextView)view.findViewById(R.id.texts1);
        final TextView tests2=(TextView)view.findViewById(R.id.texts2);
        tests1.setText(listpager3.get(position).getTexts1());
        tests2.setText(listpager3.get(position).getTexts2());
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (c>13){
                    c--;}
                else Toast.makeText(context, "لايمكن تصغير الخط اصغر من ذلك", Toast.LENGTH_SHORT).show();
        ...
        plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (c<50){
                    c++;}
                else Toast.makeText(context, "لايمكن تكبير الخط اكبر من ذلك", Toast.LENGTH_SHORT).show();
                tests1.setTextSize(c);
                tests2.setTextSize(c);
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_SUBJECT," تطبيق طريق المسلم _MuslimRoad ");
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager3.get(position).getTexts1()+"\n"+listpager3.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
                sendIntent.setType("text/plain");
                context.startActivity(Intent.createChooser(sendIntent,"مشاركه تطبيق طريق المسلم _MuslimRoad:"));
