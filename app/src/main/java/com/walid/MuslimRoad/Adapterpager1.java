...
public class Adapterpager1 extends PagerAdapter {
    ...
    public Adapterpager1(Context context, List<itempager1> listpager1) {
        this.context = context;
        this.listpager1 = listpager1;
    }

    @Override
    public int getCount() {
        return   listpager1.size();
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
     final LayoutInflater   inflater=(LayoutInflater)context.getSystemService(context.LAYOUT_INFLATER_SERVICE);
        final View view=inflater.inflate(R.layout.item_pager1,container,false);
                ...
                tests1.setText(listpager1.get(position).getTexts1());
                tests2.setText(listpager1.get(position).getTexts2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager1.get(position).getTexts1()+"\n"+listpager1.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
