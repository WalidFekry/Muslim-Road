...
public class Adapterpager2 extends PagerAdapter {
    ...
    public Adapterpager2(Context context, List<itempager1> listpager2) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager2.get(position).getTexts1());
        tests2.setText(listpager2.get(position).getTexts2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager2.get(position).getTexts1()+"\n"+listpager2.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
