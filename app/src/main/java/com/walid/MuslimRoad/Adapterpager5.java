...
public class Adapterpager5 extends PagerAdapter {
    ...
    public Adapterpager5(Context context, List<itempager1> listpager5) {
        this.context = context;
        this.listpager5 = listpager5;
    }

    @Override
    public int getCount() {
        return   listpager5.size();
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        tests1.setText(listpager5.get(position).getTexts1());
        tests2.setText(listpager5.get(position).getTexts2());
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendIntent.putExtra(Intent.EXTRA_TEXT,listpager5.get(position).getTexts1()+"\n"+listpager5.get(position).getTexts2()+"\n"+ "مشاركه نصوص من تطبيق'طريق المسلم_MuslimRoad  \n" +"\n"+ "\n"+" https://t.co/IuFGow3uyK\n");
                sendIntent.setType("text/plain");
                context.startActivity(Intent.createChooser(sendIntent,"مشاركه طريق المسلم - MuslimRoad:"));
